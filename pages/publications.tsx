    ...
    return (
        ...
        <TopNavbar />
          ...
          <Box w='100%' p={4} color='#2D3748'>
            ...
            <Publication url="https://editorial.udistrital.edu.co/detalle.php?id=1290&f=6" labels={["Book", "Deep Learning", "CNN", "Computer Vision"]} text="Convolutional neural networks using Keras and GPU acceleration"/>
            ...
            <Publication url="https://editorial.udistrital.edu.co/detalle.php?id=1388&f=6" labels={["Book", "HPC", "Image Processing", "GPU"]} text="Accelerating image fusion through heterogeneous computing"/>
